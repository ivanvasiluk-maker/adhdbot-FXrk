...
ONBOARDING_SCREENS = [
    (
        ...
        "Здесь мы тренируем не мотивацию, а навык: стартовать, держать внимание "
        "и возвращаться без самокритики.\n\n"
        "60–120 секунд в день — уже тренировка. "
        "Дальше выберешь тренера: мягкую Маршу, прямого Скинни или логичного Бека.\n\n"
        "⚠️ Это не терапия и не диагноз. Если кризис — жми «🆘 Кризис»."
    ),
]
