...
kb_crisis_tool_select = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="1️⃣ Не могу начать"), KeyboardButton(text="2️⃣ Залип")],
        [KeyboardButton(text="3️⃣ Боюсь ошибки"), KeyboardButton(text="4️⃣ Всё слишком большое")],
        [KeyboardButton(text="5️⃣ Нет сил"), KeyboardButton(text="6️⃣ Сам себя сжираю")],
        [KeyboardButton(text="7️⃣ Тревога"), KeyboardButton(text="8️⃣ Другое")],
    ],
    resize_keyboard=True,
)
...
def crisis_tool_prompt_text() -> str:
    return (
        ...
        "2️⃣ Залип\n"
        "3️⃣ Боюсь ошибки\n"
        "4️⃣ Всё слишком большое\n"
        "5️⃣ Нет сил\n"
        "6️⃣ Сам себя сжираю\n"
        "7️⃣ Тревога\n"
        "8️⃣ Другое\n\n"
        "Можно выбрать или ответить голосом."
    )
...
def crisis_tool_text(pattern: str) -> str:
    tools = {
        "attention_escape": (
            "Похоже,\n"
            "внимание ушло в быстрые награды.\n\n"
            "Сейчас не боремся с YouTube.\n"
            "Сейчас возвращаем контроль.\n\n"
            "Подбираю навык.\n\n"
            "Навык:\n\n"
            "🧩 Возврат из залипания\n\n"
            "1. Положи телефон дальше руки.\n"
            "2. Закрой одну вкладку.\n"
        ...
        "task_entry_block": (
            "Похоже,\n"
            "сломался вход в задачу.\n\n"
            "Сейчас не нужен результат.\n"
            "Нужен вход.\n\n"
            "Навык:\n\n"
            "🧩 Аварийный запуск\n\n"
            ...
            "Минимум:\n"
            "открыть место задачи."
        ),
        "perfectionism": (
            "Похоже,\n"
            "тебя тормозит не задача.\n\n"
            "Тебя тормозит цена ошибки.\n\n"
            "Навык:\n\n"
            "🧩 Плохой черновик\n\n"
            "Сейчас запрещено делать хорошо.\n\n"
            "Разрешено делать плохо.\n\n"
            "Минимум:\n"
            "1 плохое предложение."
        ),
        "overwhelm": (
            "Похоже,\n"
            "задача стала слишком большой.\n\n"
            "Уменьшаем масштаб.\n\n"
            "Навык:\n\n"
            "🧩 Резак задачи\n\n"
            "Не задача.\n\n"
            "Только первый физический шаг.\n\n"
            "Минимум:\n"
            "назвать первый шаг."
        ),
        "low_energy": (
            "Похоже,\n"
            "сейчас проблема не только в задаче.\n\n"
            "Похоже,\n"
        ...
        "self_attack": (
            "Похоже,\n"
            "сейчас тебя больше атакует самокритика,\n"
            "чем сама задача.\n\n"
            "Навык:\n\n"
        ...
        "anxiety_loop": (
            "Похоже,\n"
            "мозг сейчас пытается решить будущее.\n\n"
            "Вернёмся в настоящее.\n\n"
            "Навык:\n\n"
            "🧩 Только следующий шаг\n\n"
            "Не решай всю задачу.\n\n"
            "Назови:\n\n"
            "Что можно сделать за следующие 2 минуты?"
        ),
        "unknown": (
            "Похоже, сейчас много шума.\n\n"
            "Навык:\n\n"
            "🧩 Один управляемый шаг\n\n"
            "Не решай всё.\n\n"
            "Назови одну микроточку,\n"
            "которую можно сделать за 1–2 минуты."
        ),
    }
