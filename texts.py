...
LONG_TERM_MICRO_HABITS = [
    ...
    {"id":"return_without_punishment","title":"🌱 Микро-навык дня","text":"Если выпал из процесса — не догоняй идеально. Просто вернись с маленького шага, без наказания себя.","why":"Самонаказание усиливает избегание; мягкий возврат укрепляет устойчивость.","trainer_variants":{"beck":"Возврат без самонаказания повышает вероятность повторного старта.","skinny":"Выпал — вернись. Без драмы.","marsha":"Ты можешь вернуться маленьким шагом, даже после срыва."}},
    {"id":"pause_before_scroll","title":"🌱 Микро-навык дня","text":"Перед тем как открыть ленту, сделай паузу 3 секунды. Не запрещай себе — просто заметь момент ухода.","why":"Короткая пауза возвращает выбор и снижает автоматический уход от задачи.","trainer_variants":{"beck":"Пауза перед действием переводит автопилот в осознанный выбор.","skinny":"Стоп на 3 секунды перед скроллом.","marsha":"Небольшая пауза помогает мягко вернуть себе управление."}},
]
