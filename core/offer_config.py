...
GROUP_SESSION_EUR_MIN = _env_decimal("GROUP_SESSION_EUR_MIN", "20")
GROUP_SESSION_EUR_MAX = _env_decimal("GROUP_SESSION_EUR_MAX", "24")
GROUP_SESSION_COUNT = _env_int("GROUP_SESSION_COUNT", 12)
