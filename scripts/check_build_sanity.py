...
def check_launch_week_invariants() -> list[str]:
    ...
    adult_progress_required = (
        "День в программе",
        "Серия дней с действием",
        "Запуски",
        "Возвраты после срыва",
    ...
    day3_offer_required = (
        "За эти дни бот собрал первую карту",
        "попыток/проверок",
        "первый рабочий вход",
        "Главный следующий шаг — путь с куратором",
        "ускоритель персонализации",
        "живой разбор карты",
        "настройка личного маршрута",
        "переход от «иногда попробовал» к устойчивой системе",
        "Ты уже начал. Теперь можно не оставлять это на уровне случайных попыток",
        "Полный режим €14.98",
