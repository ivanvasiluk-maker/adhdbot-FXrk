...
async def main() -> None:
    ...
    for marker in (
        ...
        "3. Какие мысли или оценки включаются",
        "4. Какие эмоции возникают",
        "5. Что происходит в теле",
        "6. Как человек начинает избегать",
        "7. Что даёт избегание прямо сейчас",
        "8. Какую цену оно создаёт потом",
        "9. Повторяющийся цикл прокрастинации",
        "10. Ресурсы человека",
        "11. Что уже помогает",
        "12. Какие гипотезы ещё надо проверить",
        "13. Почему выбран текущий навык",
        "14. Какие навыки могут быть следующими",
    ):
        assert marker in details_text, details_text
    assert "Я опираюсь на твои слова" in details_text, details_text
