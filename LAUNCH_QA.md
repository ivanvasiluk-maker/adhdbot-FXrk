...
14. Enter `/test_access <TEST_CHEAT_CODE>` or the plain cheat code. Check `/set_day 3`, `/force_next_day`, `/show_offer` are ADMIN-only; non-admin cheat users must get “Команда недоступна.”
