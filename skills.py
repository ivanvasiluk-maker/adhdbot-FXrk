...
CORE_BASE_SKILLS = {
    "bad_first_step": {
        ...
        "steps": [
            "Выбери кусок, который можно сделать плохо",
            "Скажи: это черновик, не результат",
            "Сделай 60–90 секунд плохой версии",
        ],
        "minimum_action": "Написать одну плохую строку или кривой заголовок",
    ...
    "restart_after_slip": {
        ...
        "why_long": "Срыв становится длиннее, когда включается самонаказание. Нейтральный возврат разрывает цепочку срыв → стыд → новый срыв.",
